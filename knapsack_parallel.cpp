...
void build_table(vector<int>& K, const vector<int>& wts, const vector<int>& vals, int W, int p);
int compute_table(vector<int>& K, const vector<int>& wts, const vector<int>& vals, int W, int p);
...
int main(int argc, char* argv[]) {
    ...
    // run algorithm
    build_table(table, weight, value, capacity, p);
    ...
    // run algorithm
    int knapsackValue = compute_table(table2, weight, value, capacity, p);
    ...
    // run algorithm
    backtrack_implicit(table3, midpts, weight, value, capacity, 0, nitems-1, path, p);
...
void backtrack_implicit(vector<int>&K, vector<int>&M, const vector<int>& wts, const vector<int>& vals, int W, 
    ...
    int k = findk(K,M,wts,vals,W,first,last, p);
    ...
    backtrack_implicit(K,M,wts,vals,k,first,mid,path, p);
    backtrack_implicit(K,M,wts,vals,W-k,mid+1,last,path, p);
